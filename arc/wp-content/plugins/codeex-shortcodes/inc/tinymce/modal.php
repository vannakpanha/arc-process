			...
			<ul class="popup-div">
				<li>
					...
					<select name="typo_style" id="typo_style">
						...
						<option value="typo_qleft_border"><?php _e( 'Left with Border', 'typo_codeex_plugin' ); ?></option>
						<option value="typo_qright_border"><?php _e( 'Right with Border', 'typo_codeex_plugin' ); ?></option>
					</select>
				</li>
				<li>
					<label for="typo_type"><?php _e( 'Type', 'typo_codeex_plugin' ); ?></label>
