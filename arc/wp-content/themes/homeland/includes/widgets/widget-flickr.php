<?php
	...
	class homeland_Widget_Flickr extends WP_Widget {
		...
		function homeland_Widget_Flickr() {		
			$widget_ops = array('classname' => 'homeland_widget-flickr', 'description' => __('Custom widget for flickr feed', 'homeland'));	
			parent::__construct('Flickr', __('Homeland: Flickr Feed', 'homeland'), $widget_ops);		
		}
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;
				...
				?>
					...
					<div>			
						<div>
							<p><label for="<?php echo $this -> get_field_id($homeland_flickr_id); ?>"><?php _e('ID', 'homeland'); ?></label>
							...
							<p><label for="<?php echo $this -> get_field_id($homeland_flickr_limit); ?>"><?php _e('Number of Images', 'homeland'); ?></label>
