<?php
	...
	if($homeland_video_host == "self") : ?>
		<video id="videojs_blog" class="video-js vjs-default-skin" controls="controls" preload="none" width="100%" height="500" poster="<?php echo $homeland_large_image_url[0]; ?>" data-setup="{}">
