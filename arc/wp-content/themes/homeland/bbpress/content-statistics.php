...
<dl role="main">
	...
	<?php if ( !empty( $stats['empty_topic_tag_count'] ) ) : ?>
		...
		<dt><?php _e( 'Empty Topic Tags', 'homeland' ); ?></dt>
		<dd>
	...
	<?php if ( !empty( $stats['topic_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Topics', 'homeland' ); ?></dt>
		<dd>
			<strong>
	...
	<?php if ( !empty( $stats['reply_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Replies', 'homeland' ); ?></dt>
		<dd>
			<strong>
