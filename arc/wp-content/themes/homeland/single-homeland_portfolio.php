				...
				<?php
					...
					if(empty($homeland_hide_portfolio_prevnext)) : ?>
						<div class="post-link-blog clear">
							<span class="prev">
								<?php 
									previous_post_link( '%link', '&larr;&nbsp;' . __( 'Previous Portfolio', 'homeland' ), '' ); 
								?>
							</span>
							<span class="next">
								<?php next_post_link( '%link', __( 'Next Portfolio', 'homeland' ) . '&nbsp;&rarr;', '' ); ?>
							</span>
						</div><?php
					endif;
				?>	
			</div>
			<?php if($homeland_single_portfolio_layout != "Fullwidth") : ?>
