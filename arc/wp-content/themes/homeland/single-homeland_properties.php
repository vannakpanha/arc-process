									...
									<article id="post-<?php the_ID(); ?>" class="plist">
										...
										<?php
											if(shortcode_exists("rev_slider") && !empty($homeland_rev_slider)) : 
												...
												<div class="<?php echo $homeland_property_static_class; ?>">
														...
														<ul class="slides">
															<?php
																if ( $homeland_attachments ) :						
																	foreach ($homeland_attachments as $homeland_attachment): ?>
																		<li>
																			<?php echo wp_get_attachment_image( $homeland_attachment->ID, 'homeland_property_thumb' ); ?>
																		</li><?php
																	endforeach;
																else :
																	if ( has_post_thumbnail() ) : ?>
										...
										<?php 
											...
											if(empty($homeland_property_hide_map)) :
												if(empty($homeland_hide_map)) : ?>
													...
													<span class="map-address"><?php echo $homeland_address; ?></span>
								...
								if(empty($homeland_hide_property_prevnext)) : ?>
									<div class="post-link-blog clear">
										<span class="prev">
											<?php 
												previous_post_link( 
													'%link', '&larr;&nbsp;' . __( 'Previous Property', 'homeland' ), '' 
												); 
											?>
										</span>
										<span class="next">
											<?php 
												next_post_link( 
													'%link', __( 'Next Property', 'homeland' ) . '&nbsp;&rarr;', '' 
												); 
											?>
										</span>
									</div><?php
