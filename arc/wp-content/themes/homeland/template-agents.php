						      ...
						      ?>
						    	<div class="agent-list clear">
						    		...
						    		<div class="agent-desc">
						    				...
						    				<?php
						    					if(!empty($homeland_agent_telno)) : ?>
						    						<span>
						    							...
						    							<strong><?php _e( 'Tel no', 'homeland' ); echo ":"; ?></strong>
						    					...
						    					if(!empty($homeland_agent_mobile)) : ?>
						    						<span>
						    							...
						    							<strong><?php _e( 'Mobile', 'homeland' ); echo ":"; ?></strong>
						    					...
						    					if(!empty($homeland_agent_fax)) : ?>
						    						<span>
						    							...
						    							<strong><?php _e( 'Fax', 'homeland' ); echo ":"; ?></strong> 
							    		...
							    		<label class="listed">
							    			<i class="fa fa-home fa-lg"></i> <?php _e( 'Listed', 'homeland' ); echo ":"; ?>
							    			<span>
