	...
	*/
	...
	if ( ! function_exists( 'homeland_script_styles_reg' ) ) :
		function homeland_script_styles_reg () {
			...
			wp_enqueue_style( 'homeland_font_awesome', $homeland_directory_uri . '/includes/font-awesome/css/font-awesome.min.css' );
			...
			// Google Maps
			wp_register_script( 'homeland_gmap_sensor', 'http://maps.google.com/maps/api/js?key='. $homeland_map_api .'&libraries=geometry' );
			wp_register_script( 'homeland_gmap_marker_clusterer', $homeland_js_directory_uri . '/markerclusterer.min.js' );
	...
	if ( ! function_exists( 'homeland_custom_admin_style' ) ) :	
		function homeland_custom_admin_style() {
			...
			wp_enqueue_style( 'homeland_admin_stylesheet', $homeland_admin_directory_uri . '/admin-style.css' );
			wp_enqueue_style( 'homeland_font_awesome', $homeland_directory_uri . '/includes/font-awesome/css/font-awesome.min.css' );
			wp_enqueue_script( 'homeland_admin_js', $homeland_admin_directory_uri . '/admin-jquery.js', array(), '', true );
		}
	endif;
			   	...
			   	$(document).ready(function(){
			        ...
			        scrollwheel: false,
				      lat: <?php echo $homeland_lat; ?>,
							...
							zoom: <?php echo $homeland_map_zoom_value; ?>,
							styles : snazzyMap,
			      });
			    	<?php if(!empty($homeland_home_map_icon)) : ?>var image = '<?php echo $homeland_home_map_icon; ?>';<?php endif; ?>
